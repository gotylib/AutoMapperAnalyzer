...
### AutoMapperAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [AutoMapperAnalyzer.Sample.csproj](../AutoMapperAnalyzer.Sample/AutoMapperAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
